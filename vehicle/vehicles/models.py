...
class Customer(models.Model):
    ...
    profile_pic=models.ImageField(upload_to='profile/CustomerProfilePicture/',null=True,blank=True,default='admin.png')
...
class Mechanic(models.Model):
    user=models.OneToOneField(User,on_delete=models.CASCADE)
    profile_pic=models.ImageField(upload_to='profile/MechanicProfilePicture/',null=True,blank=True,default='mechanic.png')
